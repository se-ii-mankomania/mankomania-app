...
public class FieldsHandler implements Serializable {
    ...
    public void initFields(Cellposition[][] cellPositions) {
        ...
        fields[44] = new ActivityField( cellPositions[4][2].getX(), cellPositions[4][2].getY(), 45, "Böse 1");
        ...
        fields[0] = new GoToField( cellPositions[1][1].getX(), cellPositions[1][1].getY(), 1, fields[46]);
        ...
        fields[3] = new ProfitField( cellPositions[1][4].getX(), cellPositions[1][4].getY(), 4, -70000);
        fields[4] = new GoToField( cellPositions[1][5].getX(), cellPositions[1][5].getY(), 5, fields[46]);
        fields[5] = new ProfitField( cellPositions[1][6].getX(), cellPositions[1][6].getY(), 6, 20000);
        fields[6] = new GoToField( cellPositions[1][7].getX(), cellPositions[1][7].getY(), 7, fields[45]);

        fields[7] = new ProfitField( cellPositions[1][8].getX(), cellPositions[1][8].getY(), 8, -100000);
        fields[8] = new GoToField( cellPositions[1][9].getX(), cellPositions[1][9].getY(), 9, fields[44]);
        ...
        fields[11] = new GoToField( cellPositions[1][12].getX(), cellPositions[1][12].getY(), 12, fields[24]);

        fields[12] = new ProfitField( cellPositions[2][12].getX(), cellPositions[2][12].getY(), 13, -50000);
        fields[13] = new GoToField( cellPositions[3][12].getX(), cellPositions[3][12].getY(), 14, fields[46]);
        fields[14] = new ProfitField( cellPositions[4][12].getX(), cellPositions[4][12].getY(), 15, 10000);
        fields[15] = new ProfitField( cellPositions[5][12].getX(), cellPositions[5][12].getY(), 16, -15000);
        fields[16] = new GoToField( cellPositions[6][12].getX(), cellPositions[6][12].getY(), 17, fields[45]);
        fields[17] = new HotelField( cellPositions[7][12].getX(), cellPositions[7][12].getY(), 18, 13000, 100000, null);
        fields[18] = new GoToField( cellPositions[8][12].getX(), cellPositions[8][12].getY(), 19, fields[44]);
        ...
        fields[23] = new ProfitField( cellPositions[12][11].getX(), cellPositions[12][11].getY(), 24, -100000);
        fields[25] = new ProfitField( cellPositions[12][9].getX(), cellPositions[12][9].getY(), 26, 10000);
        fields[26] = new ProfitField( cellPositions[12][8].getX(), cellPositions[12][8].getY(), 27, -100000);
        fields[27] = new HotelField( cellPositions[12][7].getX(), cellPositions[12][7].getY(), 28, 20000, 120000, null);
        fields[28] = new ProfitField(cellPositions[12][6].getX(), cellPositions[12][6].getY(), 29, 50000);
        fields[29] = new ProfitField( cellPositions[12][5].getX(), cellPositions[12][5].getY(), 30, -15000);
        fields[30] = new ProfitField( cellPositions[12][4].getX(), cellPositions[12][4].getY(), 31, -100000);
        fields[31] = new GoToField( cellPositions[12][3].getX(), cellPositions[12][3].getY(), 32, fields[46]);
        fields[32] = new ProfitField( cellPositions[12][2].getX(), cellPositions[12][2].getY(), 33, -10000); //starter4
        fields[33] = new GoToField( cellPositions[12][1].getX(), cellPositions[12][1].getY(), 34, fields[24]);

        fields[34] = new ProfitField( cellPositions[11][1].getX(), cellPositions[11][1].getY(), 35, 30000);
        fields[35] = new ProfitField( cellPositions[10][1].getX(), cellPositions[10][1].getY(), 36, -100000);
        fields[36] = new GoToField( cellPositions[9][1].getX(), cellPositions[9][1].getY(), 37, fields[46]);
        fields[37] = new ProfitField( cellPositions[8][1].getX(), cellPositions[8][1].getY(), 38, -20000);
        fields[38] = new ProfitField( cellPositions[7][1].getX(), cellPositions[7][1].getY(), 39, -20000);
        fields[39] = new ProfitField( cellPositions[6][1].getX(), cellPositions[6][1].getY(), 40, 30000);
        fields[40] = new HotelField( cellPositions[5][1].getX(), cellPositions[5][1].getY(), 41, 5000, 40000, null);
        fields[41] = new ProfitField( cellPositions[4][1].getX(), cellPositions[4][1].getY(), 42, -100000);
        fields[42] = new GoToField( cellPositions[3][1].getX(), cellPositions[3][1].getY(), 43, fields[45]);
        fields[43] = new ProfitField( cellPositions[2][1].getX(), cellPositions[2][1].getY(), 44, -25000);
